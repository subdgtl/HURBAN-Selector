...
[Code]
const
	vcredist2015_2019_url = 'http://aka.ms/vs/16/release/vc_redist.x86.exe';
	vcredist2015_2019_url_x64 = 'http://aka.ms/vs/16/release/vc_redist.x64.exe';
	vcredist2015_2019_url_arm64 = 'http://aka.ms/vs/16/release/VC_redist.arm64.exe';
