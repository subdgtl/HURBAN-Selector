...
use crate::renderer::{Renderer, RendererDrawGeometryMode, RendererGeometry, RendererOptions};
use crate::ui::Ui;
...
pub fn init_and_run(options: Options) -> ! {
    ...
    let mut renderer_draw_geometry_mode = RendererDrawGeometryMode::Shaded;
