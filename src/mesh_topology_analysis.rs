...
pub fn face_to_face_topology(mesh: &Mesh) -> FaceToFaceTopology {
...
pub fn vertex_to_vertex_topology(mesh: &Mesh) -> VertexToVertexTopology {
...
mod tests {
    ...
    #[test]
    fn test_face_to_face_topology_does_not_include_self_in_neighbors() {
        ...
        let face_to_face_topology = face_to_face_topology(&mesh);
    ...
    #[test]
    fn test_mesh_face_to_face_topology_from_tessellated_triangle() {
        let (faces, vertices) = tessellated_triangle();
        let mesh = Mesh::from_triangle_faces_with_vertices_and_computed_normals(
            faces.clone(),
            vertices.clone(),
        ...
        let face_to_face_topology_calculated = face_to_face_topology(&mesh);
    ...
    #[test]
    fn test_mesh_vertex_to_vertex_topology_from_tessellated_triangle() {
        let (faces, vertices) = tessellated_triangle();
        let mesh = Mesh::from_triangle_faces_with_vertices_and_computed_normals(
            faces.clone(),
            vertices.clone(),
        ...
        let vertex_to_vertex_topology_calculated = vertex_to_vertex_topology(&mesh);
