//! This module provides a winit-based backend platform for imgui-rs.
//!
//! A backend platform handles window/input device events and manages their
//! state. Based on
//! https://github.com/Gekkio/imgui-rs/blob/master/imgui-winit-support/src/lib.rs.
//!
//! # Usage
//!
...
use winit::window::{CursorIcon as MouseCursor, Window};
